...
export const Header: React.FC = () => {
  ...
  return (
    <header
      className="sticky top-0 z-30 -mx-5 flex items-center justify-between border-b border-app-border/60 bg-app-bg/75 px-5 py-4 backdrop-blur-md sm:-mx-7 sm:px-7"
      data-landing-header
    >
