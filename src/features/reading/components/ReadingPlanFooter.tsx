...
export const ReadingPlanFooter: React.FC<ReadingPlanFooterProps> = ({
  ...
  return (
    <footer 
      className="fixed bottom-0 left-0 right-0 z-40 bg-white/95 backdrop-blur-md border-t border-stone-100 px-4 pb-safe shadow-[0_-4px_12px_rgba(0,0,0,0.03)]"
    ...
    >
      <div className="max-w-xl mx-auto flex items-center justify-between h-[80px]">
        ...
        <div className="flex flex-col items-center justify-center text-center select-none">
          <span className="text-[11px] font-medium text-stone-400 uppercase tracking-tight leading-tight">
        ...
        <button
          onClick={onNext}
          className="w-12 h-12 flex items-center justify-center bg-stone-900 text-white shadow-md hover:bg-stone-800 active:scale-95 transition-all rounded-full"
